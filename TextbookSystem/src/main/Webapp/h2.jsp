...
<ul>
    ...
    <li><a  class="active" href="Book4Servlet">查看缺书单</a></li>
...
<div class="divbutton">
    <center>
        ...
        <a class="previous round" href="Book4Servlet?page=${paging.indexpage-1}">&#8249;首页</a>
        <a  class="previous" href="Book4Servlet?page=${paging.page-1 }">&laquo; 上一页</a>
        <a class="next" href="Book4Servlet?page=${paging.page+1}">下一页 &raquo;</a>
        <a class="next round" href="Book4Servlet?page=${paging.pagenumber-1}">&#8250;末页</a></center>
</div>
