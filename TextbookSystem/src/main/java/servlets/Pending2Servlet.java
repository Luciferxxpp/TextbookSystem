...
@WebServlet(name = "Pending2Servlet", value = "/Pending2Servlet")

public class Pending2Servlet extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        List<In_storage> list;
        list=bookService.inStoragesbook();
        //页面当前页
        int page=0;
        //得到传过来的当前页
        ...
        List<In_storage> list_page =new ArrayList<>();
