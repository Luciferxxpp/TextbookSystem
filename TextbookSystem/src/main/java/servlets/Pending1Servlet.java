...
@WebServlet( name="Pending1Servlet",value="/Pending1Servlet")
public class Pending1Servlet extends HttpServlet {
    private AsyncContext ServletActionContext;
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        List<Book_lack> list=null;
        list=bookService.lackbook();
        ...
        List<Book_lack> list_page =new ArrayList<>();
